...
public class ActivitySettingActivity extends AppCompatActivity {
    private TextView tv_main_title;
    private TextView tv_back;
    private RelativeLayout rl_title_bar;
    private RelativeLayout rl_modify_psw,rl_security_setting,rl_exit_login;
    public static ActivitySettingActivity instace=null;
    @Override
    ...
    private void init() {
        ...
        rl_security_setting.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(ActivitySettingActivity.this,ActivityFindPswActivity.class);
        ...
        rl_exit_login.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(ActivitySettingActivity.this,"退出登录成功",Toast.LENGTH_LONG).show();
                clearLoginStatus();
